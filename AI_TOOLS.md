...
### 1. The CSV did not match the brief
...
### 2. Risk weights had to come from somewhere real
...
### 3. Downloading 3 GB to use 0.4% of it
...
### 4. Computing terrain slope once not four million times
...
### 5. One orchestrator not five separate agent classes
...
### 6. Finding nearby alternatives is math not AI
...
### 7. The map failure should not kill the report
...
### 8. The county filter needed a complete rebuild
...
### 9. Seasonal risk should advise not change the score
...
### 10. Monitoring from your own logs not a third party
